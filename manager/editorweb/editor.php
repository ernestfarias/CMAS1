...
//window.document.opener.textdesc.value = window.opener.document.form1.<? echo $t?>.value 


//  response.write (window.opener.document.form1.<? echo $t?>.value);

</script>
<!-- /TinyMCE -->
<form id="opener" name="opener" method="post" action="editorw.php">
	  <textarea id="textdesc" name="textdesc" rows="15" cols="80" style="width: 100%">
