...
Las NOTAS son para agregar mas datos imagenes y texto de una manera ordenada, las mismas se ven cuando un usuario hace click sobre su registro; puede optar entre dos modos diferentes : <br>
<br>
...
- Modo 2: Ser&aacute;n mostradas en la portada de su hoja detalles, estas son utilizadas para mostrar alg&uacute;n dato importante de r&aacute;pido acceso visual para el usuario.<br>
                                  ...
                                  <p class="Blanco12">- En caso de subir una imagen el sistema generara automaticamente una imagen miniaturizada en caso de necesitar en proximas vistas Solo utlize imagenes (JPG, PNG, BMP, GIF).                                   <br>
                                    <br>
                                    - Utilice la opcion "Previsualizar detalles", esto le permite ir viendo a medida que sube notas como van a verse sus detalles. recuerde cerrar  y volver abrir la previsualizacion cada vez que realiza una modificacion<p align="right" class="Blanco12"><a href="http://www.comermas.com.ar/detalles.php?id=<?=$IDT?>" target="_blank">Previsualizar detalles </a><br>
                                    </p></td>
                              </tr>
                            </table></td>
                          </tr>
...
$modo = $row['modo'] ;
						 ...
						 ?>
							...
							<tr>
                              ...
                              <br>
                              <br>
                              </a><span class="Naranja10"><b><a href="javascript:NewWindow('editorweb/editor.php?nombre=textimg<?=$cont?>' ,'editor','540','370');">Texto de la nota </a></b>(click para agregar/modificar/eliminar) </span></td>
							  </tr>
							<tr>
