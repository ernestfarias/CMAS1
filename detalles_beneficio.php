...
<table width="90%"  border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="13%" bgcolor="#851549">
    <div align="center"><strong>
      <?=$descuento?>
    %</strong></div></td>
    <td width="87%"><table width="100%"  border="0" cellspacing="0" cellpadding="5">
      <tr>
        <td bgcolor="#B36464" class="Blanco12"><?=$detalles?></td>
      </tr>
    </table></td>
  </tr>
<tr>
    <td colspan="2" class="Blanco10">V&aacute;lido desde el <?=$fecha_ini?>      hasta      <?=$fecha_fin?></td>
  </tr>
</table>
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><div align="right"><input type="button" name="Submit3" value="Imprimir Cupon" onClick="NewWindow('cupon.php?id=<?=$id_desc?>&action=print','cupon','586','160','no','center','no','no','no','no');return false" style=" height:20px; font-size:8pt;color:white;cursor:pointer;margin:0px;padding:0px;border:0;background-color:#851549"></div></td>
  </tr>
</table>
<br>
<? }}?>