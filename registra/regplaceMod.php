...
$rslugares = @mysql_query($sqllugares) or die (mysql_error()."2"); 
                              ...
                              <div align="right">
                                <table width="100%" height="430" border="0" align="center" cellpadding="1" cellspacing="0">
                                  ...
                                  <tr bgcolor="#B36464" class="Blanco12">
                                    <td width="36%"><div align="right">Nombre Lugar :</div></td>
                                  ...
                                  <tr bgcolor="#AE5959" class="Blanco12">
                                    <td><div align="right">Direccion(es) :</div></td>
                                    <td>
                                  ...
                                  <tr bgcolor="#AE5959" class="Blanco12">
                                    ...
                                    <td>
                                    <!--   <select name="localidad" id="localidad" style="width: 160px;font-size:8pt;" onChange="Showsucciudad(window.document.FRM_ADD.localidad.value);">
                                         <option value="Capital Federal" selected>CAPITAL FEDERAL</option>
									    <? while ($row = @mysql_fetch_array($rsciudad)) { ?>
                                        <option value="<?=$row["ciudad"];?>">
		...
		echo "<option value='".$row[0]."'>". strtoupper($row[1])."</option>";
                                  ...
                                  <tr bgcolor="#B36464" class="Blanco12">
                                    ...
                                    <td>
																		...
																		<!-- <select name="op_barrios" id="op_barrios" style="width: 160px;font-size:8pt;" onChange="Showsucbarrio(window.document.FRM_ADD.barrio.value);">
                                        ...
                                        <option value="(sucursales)... barrios>Otra</option>
																	 ...
																	 -->	
																	  ...
																	  <select class="combo"   id="op_barrios"  name="op_barrios">
