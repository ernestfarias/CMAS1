 ...
 <script language="javascript" type="text/javascript" src="../includes/editorhtml/jscripts/tiny_mce/tiny_mce.js"></script>
...
<script language="javascript" type="text/javascript">
	...
	function customSave(id, content) {
		...
		//window.opener.document.form1.<? echo $t?>.value = contect; 
	}
