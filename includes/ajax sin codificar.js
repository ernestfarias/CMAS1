       ...
       //     contenedor.innerHTML = cadenafinal;
			...
			contenedor.innerHTML = "";
			 ...
			 //  contenedorcarga.innerHTML = '<img src="includes/'+imagen+'" border="1" align="center"/>'
			   contenedorcarga.innerHTML ='<img src="includes/refresh.gif" border="0" align="center">';
...
contenedorcarga2.innerHTML ='<img src="includes/refresh.gif" border="0" align="center"/>';
}
    }
...
function CargarContenidoR(html)
{
    ...
    ajax2.onreadystatechange=function() 
    {
        if (ajax2.readyState==4 && ajax2.status==200) // Readystate 4 significa que ya acabó de cargarlo
        {
			...
			//contenedor.innerHTML = '<table width="100%"  border="0" cellspacing="0" cellpadding="0"><tr><td width="95%"><div align="left"><img src="includes/loading.gif" align="rigth"><font size="2" face="Times New Roman"> Cargando </font></div></td><td width="5%">&nbsp;</td></tr></table>';
		contenedor1.innerHTML ='<img src="includes/refresh.gif" border="0" align="center"/  >';
...
//    var contenedor2;
  ...
  var ajax2 = new Array() 
    ...
    ajax2.onreadystatechange=function() 
    {
		...
		contenedor2.innerHTML =  '<img src="includes/'+imagen+'" border="0" align="center"/>'
      ...
      while (i <= largoForm)
	    {
		 indice = i - 1;  
		 mostrar = true;
		if ((encodeURI(document.forms[0].elements[indice].checked) == "false")) 
			if ((encodeURI(document.forms[0].elements[indice].type) =="radio"))
			  		mostrar = false;
		if ((encodeURI(document.forms[0].elements[indice].value) == "undefined")) mostrar = false; 
		if ((encodeURI(document.forms[0].elements[indice].type) =="button")) mostrar = false;
		if ((encodeURI(document.forms[0].elements[indice].type) =="")) mostrar = false;
