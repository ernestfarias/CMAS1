...
if (sqsession_is_registered('session_expired_post')) {
    ...
    if ($compose_new_win == '1') {
        ...
        displayPageHeader($color, 'None','','',_('Compose'));
    }
...
function showInputForm ($session, $values=false) {
    ...
    if ($compose_new_win == '1') {
        ...
        echo '<table align="center" cellspacing="0" border="0" width="100%">' . "\n";
    }
    ...
    if ($compose_new_win == '1') {
        echo '   <tr>' . "\n" .
            ...
            '" wrap="virtual"' . $onfocus . 'style="width: 100%; border: 1px solid #666666;">';
    }
    else {
        echo '   <tr>' . "\n" .
