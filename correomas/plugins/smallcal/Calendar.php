    ...
    */
	...
	$d = getdate(time());
        ...
        else if ($smallcal_separator == 2)
        {
           ...
           global $color;
           $s .= "<table align=center width=\"95%\" cellpadding=0 cellspacing=0 border=0 bgcolor=\"$color[9]\">";
           $s .= '<tr><td >';
           $s .= "<table class=\"left_mailbox\" width=\"100%\" cellpadding=1 cellspacing=1 border=0 bgcolor=\"$color[12]\" >\n";
