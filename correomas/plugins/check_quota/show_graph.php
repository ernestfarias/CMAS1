...
if ( $cq_size_quota )
{
	if ( $cq_show_used_instead_of_percent )
		$cq_alt = sprintf(_("%s%s de %s%s"), $cq_taken, $cq_t_unit, $cq_quota, $cq_q_unit);
	else
		$cq_alt = sprintf(_("%s%% de %s%s"), $cq_percent, $cq_quota, $cq_q_unit);
	...
	echo '<div align="' . $cq_graph_align . '"><font size="' . $cq_font_size . '">' . "\n";
	...
	'&nbsp;<img src="../images/icons/quota.gif" width="24" height="24" border="0" align="absmiddle" vspace="0" hspace="3">&nbsp;<b><u>' . _("Quota Usage:") . '</u><b></td></tr>' .
	// Linha separadora
	html_tag( 'tr' ) .
