...
function startcalendar() {
    ...
    echo html_tag( 'tr', "\n".
               html_tag( 'td', "\n".
                   html_tag( 'table', '', '', $color[6], 'width="100%" border="0" cellpadding="2" cellspacing="1"' ) .
                       html_tag( 'tr', "\n".
                            html_tag( 'th',
								"<a href=\"$self?year=".($year-1)."&amp;month=$month\">&lt;&lt;&nbsp;".($year-1)."</a>", '' ,$color[3]
                            ) . "\n".
                            html_tag( 'th',
                                "<a href=\"$self?year=$prev_year&amp;month=$prev_month\">&lt;&nbsp;" .
                                date_intl( 'M', $prev_date). "</a>" , '' ,$color[3]
                            ) . "\n".
                            html_tag( 'th', date_intl( 'F Y', $act_date ), '', $color[3], 'colspan="3"') .
                            html_tag( 'th',
                                "<a href=\"$self?year=$next_year&amp;month=$next_month\">" .
                                date_intl( 'M', $next_date) . "&nbsp;&gt;</a>" , '' ,$color[3]
                            ) . "\n".
                            html_tag( 'th',
                                "<a href=\"$self?year=".($year+1)."&amp;month=$month\">".($year+1)."&nbsp;&gt;&gt;</a>" , '' ,$color[3]
                            )
                       ...
                       html_tag( 'tr',
                           html_tag( 'th', _("Sunday"), '', $color[20], 'width="14%" height="19"' ) ."\n" .
                           html_tag( 'th', _("Monday"), '', $color[20], 'width="14%"' ) ."\n" .
                           html_tag( 'th', _("Tuesday"), '', $color[20], 'width="14%"' ) ."\n" .
                           html_tag( 'th', _("Wednesday"), '', $color[20], 'width="14%" width="90"' ) ."\n" .
                           html_tag( 'th', _("Thursday"), '', $color[20], 'width="14%" width="90"' ) ."\n" .
                           html_tag( 'th', _("Friday"), '', $color[20], 'width="14%" width="90"' ) ."\n" .
                           html_tag( 'th', _("Saturday"), '', $color[20], 'width="14%" width="90"' ) ."\n"
                       )
               ) ,
           '', $color[20] ) ."\n";
}
    ...
    while ($aday <= $days_in_month) {
        ...
        for ($j=1; $j<=7; $j++) {
            ...
            if ( $aday <= $days_in_month && $aday > 0){
                echo html_tag( 'td', '', 'left', $color[18], 'height="60" valign="top"' ) ."\n".
                     html_tag( 'div', '', 'right' );
                ...
                echo html_tag( 'td', '', 'left', $color[19]) ."\n".
                     "&nbsp;";
            }
...
function endcalendar() {
    ...
    echo html_tag( 'tr' ) ."\n" .
           html_tag( 'td', '', 'left', $color[3], 'colspan="7"' ) ."\n" .
...
displayPageHeader($color, 'None', '' , '' ,_('Calendar'));
calendar_header();
readcalendardata();
startcalendar();
drawmonthview();
