...
function calendar_header() {
    ...
    echo html_tag( 'table', '', '', $color[0], 'border="0" width="100%" cellspacing="0" cellpadding="0"' ) .
         html_tag( 'tr' ) .
         html_tag( 'td', '', 'left', '', 'width="100%" height="26" background="/images/bg/bg_tb_header.gif"' );
	echo '&nbsp;<img src="/images/bg/bg_header_init.gif" border="0" align="absmiddle" hspace="1">';
	displayInternalLink("plugins/calendar/event_create.php?year=$year&amp;month=$month&amp;day=$day",'<img src="/images/icons/calendar_h.gif" border="0" align="absmiddle" hspace="3" alt="' . _("New") . '">' . _("New"),"right");
    echo "&nbsp;&nbsp;";
	echo '<img src="/images/bg/bg_header_sep.gif" border="0" align="absmiddle" hspace="1">';
    displayInternalLink("plugins/calendar/day.php?year=$year&amp;month=$month&amp;day=$day", '<img src="/images/icons/calend_day.gif" border="0" align="absmiddle" hspace="3" alt="' . _("Day View") . '">' . _("Day View"),"right");
    echo "&nbsp;&nbsp;\n";
	displayInternalLink("plugins/calendar/calendar.php?year=$year&amp;month=$month", '<img src="/images/icons/calend_month.gif" border="0" align="absmiddle" hspace="3" alt="' . _("Month View") . '">' . _("Month View"),"right");
    echo "&nbsp;&nbsp;\n";    
    echo '</td></tr>';
