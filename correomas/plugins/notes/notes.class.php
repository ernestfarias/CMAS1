...
class Notes {
   ...
   function DisplayNote($id, $edit = 0, $big = false) {
      ...
      print "<table width=$tw cellpadding=1 cellspacing=0 bgcolor='" . $color[17] . "'><tr><td>";
      print "<table width='100%' bgcolor='" . $color[17] . "' cellspacing=0 cellpadding=0>";
      print "<tr><td bgcolor='" . $color[3]  . "'><center><table width='99%'><tr><td>";
      if (!$edit) {
