...
function displayPageHeader($color, $mailbox, $xtra='', $session=false, $title_page) {
    ...
    echo "<body text=\"$color[8]\" bgcolor=\"$color[20]\" link=\"$color[7]\" vlink=\"$color[7]\" alink=\"$color[7]\" $onload leftmargin=\"0\" topmargin=\"0\" rightmargin=\"0\" bottommargin=\"0\" marginwidth=\"0\" marginheight=\"0\">\n\n";
    ...
    echo "<a name=\"pagetop\"></a>\n"
        . html_tag( 'table', '', '', $color[4], 'border="0" width="100%" cellspacing="0" cellpadding="0"' ) ."\n"
        . html_tag( 'tr', '', '', $color[9] ) ."\n"
        . html_tag( 'td', '', 'left','808080','heigth="25" class="titulo_topo"') ."\n";
	...
	displayInternalLink ('src/signout.php', '<img src="/images/icons/exit.gif" border="0" align="absmiddle" hspace="3" alt="' . _("Sign Out") . '">' . _("Sign Out"), $frame_top);
	
    echo "</b></td>\n"
        . "   </tr>\n"
        . html_tag( 'tr', '', '', $color[4] ) ."\n"
        . ($hide_sm_attributions ? html_tag( 'td', '', 'left', '', 'colspan="2" height="26" background="/images/bg/bg_tb_header.gif"' )
                                 : html_tag( 'td', '', 'left' ,'808080','height="26" background="/images/bg/bg_tb_header.gif"') )
        . "\n";
    $urlMailbox = urlencode($mailbox);
    $startMessage = (int)$startMessage;
	echo '&nbsp;<img src="/images/bg/bg_header_init.gif" border="0" align="absmiddle" hspace="1">';
    echo makeComposeLink('src/compose.php?mailbox='.$urlMailbox.'&amp;startMessage='.$startMessage);
    echo "&nbsp;&nbsp;\n";
	echo '<img src="/images/bg/bg_header_sep.gif" border="0" align="absmiddle" hspace="1">';
    displayInternalLink ('src/folders.php', '<img src="/images/icons/other.gif" border="0" align="absmiddle" hspace="3" alt="' . _("Folders") . '">' . _("Folders"));
    echo "&nbsp;&nbsp;\n";
    displayInternalLink ("src/search.php?mailbox=$urlMailbox",'<img src="/images/icons/search.gif" border="0" align="absmiddle" hspace="3" alt="' . _("Search") . '">' . _("Search"));
    echo "&nbsp;&nbsp;\n";
	displayInternalLink ('src/addressbook.php', '<img src="/images/icons/catalog.gif" border="0" align="absmiddle" hspace="3" alt="' . _("Addresses") . '">');
	echo '<img src="/images/bg/bg_header_sep.gif" border="0" align="absmiddle" hspace="1">';
	do_hook('menuline');
	echo '<img src="/images/bg/bg_header_sep.gif" border="0" align="absmiddle" hspace="1">';
	displayInternalLink ('src/options.php', '<img src="/images/icons/options.gif" border="0" align="absmiddle" hspace="3" alt="' . _("Options") . '">' . _("Options"));
    echo "&nbsp;&nbsp;\n";
    displayInternalLink ('src/help.php', '<img src="/images/icons/help.gif" border="0" align="absmiddle" hspace="3" alt="' . _("Help") . '">');
    echo "</td>\n";

    if (!$hide_sm_attributions)
    {
        echo html_tag( 'td', '', 'right', 'height="26" background="/images/bg/bg_tb_header.gif"')  ."\n";
    ...
    echo "</tr>\n";
	echo html_tag( 'tr' ) ."\n" .
	($hide_sm_attributions	? html_tag( 'td', '', '', '808080', 'colspan="2" height="1"' )
							: html_tag( 'td', '', '' ,'808080','colspan="2" height="1"') )
							. "</td></tr>\n";
     echo "</table>\n\n";
}
...
function compose_Header($color, $mailbox) {
    ...
    */
    ...
    echo "<body text=\"$color[8]\" bgcolor=\"$color[4]\" link=\"$color[7]\" vlink=\"$color[7]\" alink=\"$color[7]\" $onload leftmargin=\"0\" topmargin=\"0\" rightmargin=\"0\" bottommargin=\"0\" marginwidth=\"0\" marginheight=\"0\">\n\n";
}
?>