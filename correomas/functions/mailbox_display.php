...
function printMessageInfo($imapConnection, $t, $not_last=true, $key, $mailbox,
    ...
    if (isset($msg['FLAG_DELETED']) && $msg['FLAG_DELETED']) {
        $fontstr = "<span class=\"deleted\"><font color=\"#808080\">";
        $fontstr_end = '</font></span>';
    } else {
        $fontstr = '';
        $fontstr_end = '';
    }
...
//    $subject = processSubject($msg['SUBJECT'], $indent_array[$msg['ID']]);
            ...
            case 5: /* flags */
                ...
                if ($default_use_priority) {
                    if ( ($msg['PRIORITY'] == 1) || ($msg['PRIORITY'] == 2) ) {
                        $td_str .= "<img src=\"../images/icons/priority_up.gif\" width=\"8\" height=\"10\">";
                        $stuff = true;
                    }
                    if ($msg['PRIORITY'] == 5) {
                        $td_str .= "<img src=\"../images/icons/priority_down.gif\" width=\"8\" height=\"10\">";
                        $stuff = true;
                    }
                }
				// removido para deixar somente o anexo pois ja foi setado o traco no texto atraves do CSS
    ...
    if ($not_last) {
        echo '</tr>' . "\n" . '<tr><td colspan="' . $col . '" bgcolor="808080" height="1"></td></tr>' . "\n";
    } else {
        echo '</tr>'."\n";
    }
}
...
function displayMessageArray($imapConnection, $num_msgs, $start_msg,
    ...
    /* if there's no messages in this folder */
        echo html_tag( 'tr',
                html_tag( 'td',
                          "<br><b>" . _("THIS FOLDER IS EMPTY") . "</b><br><br>",
                          'center',
                          $color[4],
                          'colspan="' . count($index_order) . '"'
                )
        );
		// Adicionado para resolver o problema da lista vazia
		echo "</td></tr></table>";
...
function mail_message_listing_beginning ($imapConnection,
	...
	/* line between header and button area */
        echo '<tr><td height="5" bgcolor="'.$color[4].'"></td></tr>'; // tirado para deixar o codigo html mais limpo! </td></tr>
...
function printHeader($mailbox, $sort, $color, $showsort=true) {
    global $index_order;
	echo html_tag( 'table', '', '', 'FFFFFF', 'border="0" cellspacing="0" cellpadding="0" width="100%" background="../images/bg/bg_tb_message.gif"' );
    echo html_tag( 'tr' ,'' , 'center', '' );
    ...
    foreach ($index_order as $item) {
        switch ($item) {
        case 1: /* checkbox */
			echo html_tag( 'td' ,'<img src="../images/icons/select_all.gif" width="13" height="13" border="0" vspace="0" hspace="0" align="absmiddle">' , 'center', '', 'width="22" height="22" valign="middle" nowrap' );
            break;
        case 5: /* flags */
            echo html_tag( 'td' ,'<img src="../images/bg/bg_tb_sep.gif" width="2" height="16" hspace="0" vspace="0" align="absmiddle"><img src="../images/icons/flag_1.gif" width="3" height="11" border="0" hspace="2" vspace="0" align="absmiddle">' , 'center', '', 'width="10" height="22" valign="middle" nowrap' );
            break;
        case 2: /* from */
            if (handleAsSent($mailbox)) {
                echo html_tag( 'td' ,'' , 'left', '', 'width="25%" height="22"' )  . "<img src=\"../images/bg/bg_tb_sep.gif\" width=\"2\" height=\"16\" vspace=\"0\" hspace=\"0\" align=\"absmiddle\">&nbsp;" . _("To") . "&nbsp;" ;
            } else {
                echo html_tag( 'td' ,'' , 'left', '', 'width="25%" height="22"' ) . "<img src=\"../images/bg/bg_tb_sep.gif\" width=\"2\" height=\"16\" vspace=\"0\" hspace=\"0\" align=\"absmiddle\">&nbsp;" . _("From") . "&nbsp;" ;
            }
            if ($showsort) {
            ...
            break;
        case 3: /* date */
            echo html_tag( 'td' ,'' , 'left', '', 'width="10%" height="22" nowrap' )  . "<img src=\"../images/bg/bg_tb_sep.gif\" width=\"2\" height=\"16\" vspace=\"0\" align=\"absmiddle\">&nbsp;" . _("Date") . "&nbsp;" ;
            if ($showsort) {
            ...
            break;
        case 4: /* subject */
            echo html_tag( 'td' ,'' , 'left', '', 'width="'.$subjectwidth.'%"' )  . "<img src=\"../images/bg/bg_tb_sep.gif\" width=\"2\" height=\"16\" vspace=\"0\" align=\"absmiddle\">&nbsp;" . _("Subject") . "&nbsp;" ;
            if ($showsort) {
            ...
            break;
        case 6: /* size */
            echo html_tag( 'td', '<img src="../images/bg/bg_tb_sep.gif" width="2" height="16" vspace="2" align="absmiddle">&nbsp;' . _("Size") . '&nbsp;', 'center', '', 'width="8%" nowrap' );
            break;
        }
    }
    echo "</tr>\n";
...
function ShowSortButton($sort, $mailbox, $Up, $Down ) {
    ...
    echo ' <a href="' . $source_url .'?newsort=' . $which
         ...
         . '"><img src="../images/icons/' . $img
         . '" border="0" hspace="5" alt="Ordernar"></a>';
}
